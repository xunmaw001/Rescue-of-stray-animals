    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(lingyang !=null){
            ...
            BeanUtils.copyProperties( lingyang , view );//把实体数据重构到view中
                ...
                //级联表
                XinxifabuEntity xinxifabu = xinxifabuService.selectById(lingyang.getXinxifabuId());
                if(xinxifabu != null){
    ...
    */
    ...
    public R save(@RequestBody LingyangEntity lingyang, HttpServletRequest request){
        ...
        Wrapper<LingyangEntity> queryWrapper = new EntityWrapper<LingyangEntity>()
            .eq("xinxifabu_id", lingyang.getXinxifabuId())
        ...
        if(lingyangEntity==null){
            lingyang.setInsertTime(new Date());
...
//                            lingyangEntity.setXinxifabuId(Integer.valueOf(data.get(0)));   //信息发布 要改的
//                            lingyangEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            lingyangEntity.setInsertTime(date);//时间
